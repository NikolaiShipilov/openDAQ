...
void wrapDaqComponentOpenDaq(pybind11::module_ m)
{
    ...
    auto classIAuthenticationConfigMirrored = declareIAuthenticationConfigMirrored(m);
    ...
    defineIAuthenticationConfigMirrored(m, classIAuthenticationConfigMirrored);
